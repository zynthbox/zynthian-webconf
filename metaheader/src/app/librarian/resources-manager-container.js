...
function ResourcesManagerContainer() {
  ...
  return (
    <>
          <Helmet>
              <title>Zynthbox - Resources - {rootName}</title>        
          </Helmet>
