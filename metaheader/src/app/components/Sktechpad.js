...
function Sktechpad() {
    ...
    if(sketchpad){
        ...
        if(track.trackType === "sample-trig" || track.trackType === "synth"){
            ...
            synths = track.synthRoutingData;
            fxs = track.fxRoutingData;	
            mode = 'Synth'
  ...
  return (
                <div className="tw:w-full tw:mx-auto tw:p-4">
                    {sketchpadInfo && 
                       <p> Current active : {sketchpadInfo.lastSelectedSketchpad.split('/zynthian/zynthian-my-data/sketchpads/my-sketchpads/')[1]} </p>
                    }
                    ...
                    <div className="tw:p-4 tw:bg-white tw:rounded-lg tw:shadow-md tw:mt-4">                        
                        ...
                        {(track && (track.trackType=='synth' || track.trackType=='sample-trig')) &&
                            ...
                            <div className="tw:grid tw:grid-cols-12 tw:gap-4">
                                ...
                                {
                                    synths && synths.map(s=>(
                                                <div className="tw:col-span-2 tw:border-b-[1px] tw:border-gray-300">
                                                    {s && TruncatedText(s.name,10)}
                                                </div>
                                            )                                        
                                        )
                                }                                                         
